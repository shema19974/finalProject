...
class LeavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leafe" do
    assert_difference('Leafe.count') do
      post leaves_url, params: { leafe: { description: @leafe.description, employee_id: @leafe.employee_id, leave_type: @leafe.leave_type, status: @leafe.status } }
    end
  ...
  test "should update leafe" do
    patch leafe_url(@leafe), params: { leafe: { description: @leafe.description, employee_id: @leafe.employee_id, leave_type: @leafe.leave_type, status: @leafe.status } }
